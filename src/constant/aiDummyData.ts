export const aiDummyData={
  "overall_match_percentage": 68,
  "summary": {
    "fit_level": "Moderate Match",
    "reason": "Your resume covers most core frontend and MERN stack skills required for a React.js Developer role, including React, JavaScript, REST APIs, Git, and responsive UI development. However, several important React ecosystem tools and industry practices are missing or not explicitly mentioned."
  },
  "skills_matching": {
    "frontend": [
      "HTML",
